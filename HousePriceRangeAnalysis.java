...
public class HousePriceRangeAnalysis {
    ...
    private static void analyzePriceRange(List<PriceRangeData> 数据, String 范围名称, int 范围索引) {
        ...
        // 提取数据
        double[] 中介单价数组 = 数据.stream().mapToDouble(d -> d.中介单价).toArray();
        double[] 国信达单价数组 = 数据.stream().mapToDouble(d -> d.国信达单价).toArray();
        double[] 国信达总价数组 = 数据.stream().mapToDouble(d -> d.国信达总价).toArray();
