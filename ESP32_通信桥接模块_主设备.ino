/*
 * ESP32 通信桥接模块 - 主设备版本
 * 功能：连接Mega2560主设备，实现无线数据同步
 * 架构：Mega2560主设备 ←→ ESP32 ←→ WiFi/UDP ←→ ESP32 ←→ Mega2560从设备
 */
...
IPAddress target_ip(192, 168, 1, 102); // 目标ESP32的IP地址（从设备）
...
void setup() {
  ...
  Serial.println("==========================================");
  Serial.println("ESP32 通信桥接模块启动 - 主设备");
  Serial.println("==========================================");
