...
// 蓝牙设备名称
const char* BT_DEVICE_NAME = "ESP32-32_Test";
...
void setup() {
  ...
  Serial.println();
  Serial.println("==========================================");
  Serial.println("ESP32-32 蓝牙测试程序");
  Serial.println("==========================================");
  ...
  if (btResult) {
    ...
    Serial.println("2. 搜索设备：ESP32-32_Test");
