...
void setup() {
  ...
  Serial.println("=== 模块发送修复程序 ===");
  Serial.println("修复433MHz模块的发送功能");
  Serial.println("=================================");
  
  delay(2000);
  
  // 修复模块发送功能
  Serial.println(">>> 开始修复模块发送功能...");
