/*
 * Serial2接收测试程序
 * 专门测试Arduino的Serial2接收功能
 * 
 * 接线：
 * Arduino Mega 2560    →    USB-TTL
 * 引脚16 (TX)         →    RXD
 * 引脚17 (RX)         →    TXD
 * GND                 →    GND
 * 5V/3.3V             →    VCC
...
void setup() {
  ...
  Serial.println("=== Serial2接收测试程序 ===");
  Serial.println("专门测试Arduino的Serial2接收功能");
  Serial.println("用USB-TTL发送测试数据");
  Serial.println("===============================");
  ...
  Serial.println(">>> Serial2接收缓冲区已清空，开始监听...");
  Serial.println(">>> 请用USB-TTL发送测试数据");
}
